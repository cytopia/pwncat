...
print_test_case "[103] Behaviour: (UDP) Client stays alive after Server quits (${PYVER})"
...
run_test() {
	...
	# --------------------------------------------------------------------------------
	# TEST: Client stayed alive
	# --------------------------------------------------------------------------------
	echo;print_h2 "(5/5) Test: Client stays alive after Server quits"
